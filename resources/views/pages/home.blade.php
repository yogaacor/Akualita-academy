...
@section('title', 'Akualita Academy - Main')

@section('content')

<!-- Bagian 1 halaman utama -->
<section class="w-full min-h-screen text-white pt-14 pb-10 px-6 md:px-16" style="background-image: url('{{ asset('storage/Bg/bg-utama-2.png') }}'); background-size: cover; background-position: center;">
